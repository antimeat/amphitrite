...
-   **Dashboard**: GUI for maintaining configuration, monitoring logs and manual activation of scripts (see <a href="http://wa-vw-er/webapps/er_ml_projects/davink/amphitrite_dev/amphitrite/html/dashboard.php" target="_blank">dashboard</a>).
...
Amphitrite features a frontend <a href="http://wa-vw-er/webapps/er_ml_projects/davink/amphitrite_dev/amphitrite/html/dashboard.php" target="_blank">dashboard</a> for managing site configurations and manually activating the partition splitting scripts.
...
API and package for calculating and returning autoseas swell data from winds and partitioned data. More detailed information is here (see <a href="http://wa-vw-er/webapps/er_ml_projects/davink/amphitrite_dev/amphitrite/docs/README_AUTOSEAS.html" target="_blank">README_AUTOSEAS</a>).
...
-   This is the main script that calls other partitioning scripts. It includes a `PartitionSplitter` class with methods to handle wave spectra data, transform it into different formats, and integrate/interact with the database.
    ...
    <a href="http://wa-vw-er/webapps/er_ml_projects/davink/amphitrite_dev/amphitrite/html/dashboard.php" target="_blank">go-to dashboard</a> -> Activate run
...
A detailed guide for the `api.cgi` is here: <a href="http://wa-vw-er/webapps/er_ml_projects/davink/amphitrite_dev/amphitrite/docs/README_API.html" target="_blank">README_API</a>
...
A detailed guide for the `sites_api.cgi` is here: <a href="http://wa-vw-er/webapps/er_ml_projects/davink/amphitrite_dev/amphitrite/docs/README_SITES_API.html" target="_blank">README_SITES_API</a>
...
Errors are logged to [logfile.log](http://wa-vw-er/webapps/er_ml_projects/davink/amphitrite_dev/amphitrite/logfile.log). Ensure the log file is writable by the web server.
