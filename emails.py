...
def send_email(message, subject="Poseidon & Amphitrite in development! [SEC=UNOFFICIAL]", emoji="\U0001F3C4", sender="ImARobot@bom.gov.au", test_recipient="daz.vink@bom.gov.au", recipient="daz.vink@bom.gov.au"):
