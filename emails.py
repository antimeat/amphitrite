...
def send_email(message, subject="Amphitrite has arrived [SEC=UNOFFICIAL]", emoji="\U0001F3C4", sender="davink", recipient="davink@wa-vw-er.bom.gov.au;energy-resources-ops@bom.gov.au;leo.peach@bom.gov.au"):
    if emoji:
